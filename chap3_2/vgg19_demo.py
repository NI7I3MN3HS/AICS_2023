...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        # pool1
        input_pool1=pycnnl.IntVector(4)
        input_pool1[0]=1
        input_pool1[1]=64
        input_pool1[2]=224
        input_pool1[3]=224

        self.net.createPoolingLayer('pool1', input_pool1, 2, 2)
        ...
        # pool2
        input_pool2=pycnnl.IntVector(4)
        input_pool2[0]=1
        input_pool2[1]=128
        input_pool2[2]=112
        input_pool2[3]=112

        self.net.createPoolingLayer('pool2', input_pool2, 2, 2)
        ...
        # pool3
        input_pool3=pycnnl.IntVector(4)
        input_pool3[0]=1
        input_pool3[1]=256
        input_pool3[2]=56
        input_pool3[3]=56

        self.net.createPoolingLayer('pool3', input_pool3, 2, 2)
        ...
        # pool4
        input_pool4=pycnnl.IntVector(4)
        input_pool4[0]=1
        input_pool4[1]=512
        input_pool4[2]=28
        input_pool4[3]=28

        self.net.createPoolingLayer('pool4', input_pool4, 2, 2)
        ...
        # pool5
        input_pool5=pycnnl.IntVector(4)
        input_pool5[0]=1
        input_pool5[1]=512
        input_pool5[2]=14
        input_pool5[3]=14

        self.net.createPoolingLayer('pool5', input_pool5, 2, 2)
